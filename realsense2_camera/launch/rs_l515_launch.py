...
l515_parameters = [
    {'name': 'device_type', 'default': 'l515', 'description': 'choose device by type'},
    ...
    {'name': 'camera_name', 'default': 'l515', 'description': 'camera unique name'},
]
...
def generate_launch_description():
    ...
    return LaunchDescription(
        ...
        rs_launch.declare_configurable_parameters(l515_parameters) +
        [
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource([ThisLaunchFileDir(), '/rs_launch.py']),
                launch_arguments=rs_launch.set_configurable_parameters(l515_parameters).items(),
            ),
        ]
    )
